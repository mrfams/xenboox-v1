# Skill: Load Xenboox Context

> Use at the start of EVERY session working on the Xenboox codebase.
> Loads product context so you understand what you're building, not just how.
...
const AgentState = Annotation.Root({
  ...
  currentOperation: Annotation<{ type: string; status: string; input: unknown; output: unknown; error: string | null } | null>,
