...
export const attachmentTypeEnum = pgEnum("attachment_type", ["document", "image", "file"])
...
export const conversations = pgTable("conversations", {
  ...
  forkedFromConversationId:  uuid("forked_from_conversation_id").references((): any => conversations.id),
