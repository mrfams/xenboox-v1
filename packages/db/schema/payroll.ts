...
export const employeeContractsRelations = relations(employeeContracts, ({ one }) => ({
  entity: one(entities, { fields: [employeeContracts.entityId], references: [entities.id] }),
...
export const payrollDeductionTypesRelations = relations(payrollDeductionTypes, ({ one }) => ({
  entity: one(entities, { fields: [payrollDeductionTypes.entityId], references: [entities.id] })
}))
...
export const payrollRuns = pgTable("payroll_runs", {
  ...
  totalEmployerContributions: numeric("total_employer_contributions", { precision: 15, scale: 2 }).notNull().default("0"),
...
export const payrollRunsRelations = relations(payrollRuns, ({ one, many }) => ({
  entity: one(entities, { fields: [payrollRuns.entityId], references: [entities.id] }),
...
export const payrollLineItems = pgTable("payroll_line_items", {
  ...
  basicSalary: numeric("basic_salary", { precision: 15, scale: 2 }).notNull(),
  allowances: jsonb("allowances").default([]).$type<Array<{ name: string; amount: string }>>(),
  grossPay: numeric("gross_pay", { precision: 15, scale: 2 }).notNull(),
  payeTax: numeric("paye_tax", { precision: 15, scale: 2 }).notNull().default("0"),
  socialSecurityEmployee: numeric("social_security_employee", { precision: 15, scale: 2 }).notNull().default("0"),
  socialSecurityEmployer: numeric("social_security_employer", { precision: 15, scale: 2 }).notNull().default("0"),
  otherDeductions: numeric("other_deductions", { precision: 15, scale: 2 }).notNull().default("0"),
  loanDeduction: numeric("loan_deduction", { precision: 15, scale: 2 }).notNull().default("0"),
...
export const payrollLineItemsRelations = relations(payrollLineItems, ({ one }) => ({
  entity: one(entities, { fields: [payrollLineItems.entityId], references: [entities.id] }),
  payrollRun: one(payrollRuns, { fields: [payrollLineItems.payrollRunId], references: [payrollRuns.id] }),
...
export const payslipsRelations = relations(payslips, ({ one }) => ({
  entity: one(entities, { fields: [payslips.entityId], references: [entities.id] }),
  ...
  document: one(documents, { fields: [payslips.documentId], references: [documents.id] })
}))
...
export const staffLoans = pgTable("staff_loans", {
  ...
  monthlyDeduction: numeric("monthly_deduction", { precision: 15, scale: 2 }).notNull(),
...
export const staffLoansRelations = relations(staffLoans, ({ one }) => ({
  entity: one(entities, { fields: [staffLoans.entityId], references: [entities.id] }),
  employee: one(employees, { fields: [staffLoans.employeeId], references: [employees.id] })
}))
