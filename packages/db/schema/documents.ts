import { pgTable, uuid, text, integer, numeric, boolean, timestamp, jsonb, pgEnum, index } from "drizzle-orm/pg-core"
...
export const auditLogRelations = relations(auditLog, ({ one }) => ({
  entity: one(entities, { fields: [auditLog.entityId], references: [entities.id] }),
...
export const agentActivityRelations = relations(agentActivity, ({ one }) => ({
  entity: one(entities, { fields: [agentActivity.entityId], references: [entities.id] })
}))
