...
| N42a | FX revaluation cut-over behind LEDGER_PRIMARY_FX; engine line FX stamps in tamper evidence | apps/web/server/routers/currency.ts, packages/ledger | N37 | passed (Run Phase) |
| N43 | Banking categorization cut-over behind LEDGER_PRIMARY_BANKING — G4 cut-over COMPLETE (all posting paths engine-routable) | apps/web/server/routers/banking.ts | N42a | passed (Run Phase) |
...
| N51 | Tabular pass on money-needs-you; component swap deferred (churn ≠ honesty) | apps/web/components/operations/money-needs-you.tsx | N50 | passed (Run Phase) |
