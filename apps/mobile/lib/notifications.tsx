...
export function NotificationsProvider({ children }: { children: React.ReactNode }) {
  ...
  function setupNotificationListeners() {
    Notifications.setNotificationListenerAsync((notification) => {
      const newNotification: Notification = {
        ...
        data: notification.notification.request.data as Record<string, unknown> | undefined,
        date: new Date(),
        read: false,
      }
  ...
  async function loadUserNotifications() {
    ...
    try {
      ...
      const result = await trpc.notifications.list.query({ entityId: entityId || undefined })
