  ...
  return (
    <View className="flex-1 bg-slate-50 dark:bg-slate-900">
      <Header
        ...
        rightAction={
          <Pressable onPress={() => router.push("/(modules)/fixed-assets/create")}>
      ...
      <FlatList
        data={assets || []}
        renderItem={({ item }) => (
          <Pressable onPress={() => router.push(`/(modules)/fixed-assets/${item.id}`)}>
              ...
              <CardContent>
                <View className="flex-row items-center justify-between">
                  ...
                  <View className="items-end">
                    ...
                    <Text variant="caption">NBV: {formatCurrency(item.netBookValue)}</Text>
                    <Text
                      variant="caption"
