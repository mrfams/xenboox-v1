 ...
 */
export async function getEnrichedEntityContext(entityId: string): Promise<EnrichedEntityContext> {
  ...
  return {
    ...
    orgType: entity.organization?.type ?? "business",
 ...
 */
export function enrichPrompt(template: string, ctx: EnrichedEntityContext): string {
  return template
