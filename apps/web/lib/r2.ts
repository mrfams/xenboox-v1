...
export async function getPresignedDownloadUrl(storagePath: string): Promise<string> {
...
export function generateStoragePath(entityId: string, fileName: string): string {
