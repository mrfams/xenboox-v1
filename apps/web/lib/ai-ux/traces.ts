...
export const AI_UX_TRACES: AiUxTrace[] = [
  ...
  // ── Journal — second workflow: post-review anomaly audit ───────────────
  t(
    "journal-review",
    "AI Review Entries",
    "The controller audits recent postings for duplicates, unbalanced rounding, and entries that skipped approval.",
    "Journal Entries",
    "~30s run",
    ["controller", "ledger", "compliance"],
    [
      {
        kind: "think",
        agent: "controller",
        text: "Reviewing the last 90 days of postings — scanning for duplicates, unbalanced lines, and entries that skipped approval.",
        ms: 2600,
      },
      {
        kind: "act",
        agent: "controller",
        text: "Running anomaly checks across 214 journal entries — date gaps, unusual round amounts, and memo-less adjustments.",
        ms: 3200,
      },
      {
        kind: "tool",
        agent: "ledger",
        tool: "ledger.auditTrail",
        detail:
          "14 flagged · 3 possible duplicates · 1 unbalanced rounding · 0 missing approvals",
        ms: 2600,
      },
      {
        kind: "act",
        agent: "compliance",
        text: "Cross-checking the flagged entries against policy — 2 need reversal, 1 needs a supporting memo.",
        ms: 3000,
      },
      {
        kind: "approval",
        agent: "controller",
        text: "Review package ready — 3 entries recommended for reversal or correction.",
        ms: 2800,
        confidence: 94,
      },
      {
        kind: "complete",
        agent: "ledger",
        text: "Corrections drafted and queued — your review decides what posts.",
      },
    ],
  ),
  // ── Estimates — second workflow: margin & follow-up review ──────────────
  t(
    "estimate-margin-review",
    "AI Review Margins",
    "Open estimates get a margin sanity check — expiring quotes nudged, under-priced ones flagged for re-quote.",
    "Estimates",
    "~28s run",
    ["ar", "cfo"],
    [
      {
        kind: "think",
        agent: "ar",
        text: "Scanning 38 open estimates — comparing quoted margins to actual costs and flagging the ones that expire this week.",
        ms: 2400,
      },
      {
        kind: "act",
        agent: "ar",
        text: "Pulling cost history for the 5 lowest-margin quotes to see where the estimates drifted.",
        ms: 3000,
      },
      {
        kind: "tool",
        agent: "ar",
        tool: "sales.estimateMargins",
        detail: "5 below target · 3 expiring in 48h · 2 under-priced by >8%",
        ms: 2400,
      },
      {
        kind: "act",
        agent: "cfo",
        text: "Prioritizing follow-ups — expiring quotes get a final nudge, under-priced ones get a re-quote recommendation.",
        ms: 2800,
      },
      {
        kind: "approval",
        agent: "ar",
        text: "Follow-up plan ready — 3 nudges, 2 re-quotes, 1 to close as lost.",
        ms: 2600,
        confidence: 90,
      },
      {
        kind: "complete",
        agent: "cfo",
        text: "Estimate review complete — the sales-to-cash handoff is protected.",
      },
    ],
  ),
  // ── Chart of Accounts — second workflow: account suggestions ────────────
  t(
    "coa-suggest-accounts",
    "AI Suggest Accounts",
    ...
    [
      {
        kind: "think",
        agent: "controller",
        text: "Analyzing 6 months of transactions against the current chart — looking for miscategorized and missing accounts.",
        ms: 2400,
      },
      {
        kind: "act",
        agent: "controller",
        text: "Clustering vendor and expense patterns to spot where the chart forces awkward postings.",
        ms: 3000,
      },
      {
        kind: "tool",
        agent: "ledger",
        tool: "accounts.suggest",
        detail: "3 new accounts proposed · 2 merges · 5 renames with mappings",
        ms: 2400,
      },
      {
        kind: "act",
        agent: "ledger",
        text: "Mapping the current ledger so the proposed chart is a safe, reversible migration.",
        ms: 2800,
      },
      {
        kind: "approval",
        agent: "controller",
        text: "Chart refresh ready — 3 accounts to create, 2 to merge, 5 to rename.",
        ms: 2600,
        confidence: 89,
      },
      {
        kind: "complete",
        agent: "ledger",
        text: "Proposal staged — one click applies the new chart with full history mapping.",
      },
    ],
  ),
  // ── Reconciliation — second workflow: bank auto-matching ────────────────
  t(
    ...
    [
      {
        kind: "think",
        agent: "treasury",
        text: "Pulling the latest bank statement and building the candidate match pool against June's ledger.",
        ms: 2800,
      },
      {
        kind: "act",
        agent: "treasury",
        text: "Matching by amount, date-window, and reference — scoring every candidate pair.",
        ms: 3200,
      },
      {
        kind: "tool",
        agent: "reconciliation",
        tool: "bank.autoMatch",
        detail: "312 of 338 lines matched · 26 to review",
        ms: 2600,
      },
      {
        kind: "act",
        agent: "reconciliation",
        text: "Reviewing the unmatched lines — 9 are bank-only fees, 14 are duplicates needing resolution.",
        ms: 3000,
      },
      {
        kind: "approval",
        agent: "reconciliation",
        text: "Auto-match complete — 312 matched, 26 flagged for your review.",
        ms: 2800,
        confidence: 96,
      },
      {
        kind: "complete",
        agent: "ledger",
        text: "Reconciliation progressed to 92% — the flagged lines keep the audit trail honest.",
      },
    ],
  ),
  // ── Fixed Assets — second workflow: asset health review ────────────────
  t(
    "fixed-assets-health",
    "AI Asset Health",
    ...
    [
      {
        kind: "think",
        agent: "controller",
        text: "Reviewing the asset register — 23 assets, checking book values against useful life and usage.",
        ms: 2600,
      },
      {
        kind: "act",
        agent: "controller",
        text: "Flagging fully-depreciated assets still on the books and candidates for disposal.",
        ms: 3000,
      },
      {
        kind: "tool",
        agent: "ledger",
        tool: "assets.register",
        detail:
          "4 fully depreciated · 2 disposal candidates · 1 possible impairment",
        ms: 2600,
      },
      {
        kind: "act",
        agent: "ledger",
        text: "Drafting the journal entries — disposals, impairment write-down, and the GL mapping.",
        ms: 3200,
      },
      {
        kind: "approval",
        agent: "controller",
        text: "Asset health report ready — 7 recommendations across 23 assets.",
        ms: 2800,
        confidence: 92,
      },
      {
        kind: "complete",
        agent: "ledger",
        text: "Depreciation and disposal entries staged — your approval posts them.",
      },
    ],
  ),
  // ── Tax & Compliance — second workflow: compliance & deadline check ──────
  t(
    ...
    [
      {
        kind: "think",
        agent: "compliance",
        text: "Cross-checking every active jurisdiction's filings against their statutory deadlines and the filing calendar.",
        ms: 2600,
      },
      {
        kind: "act",
        agent: "compliance",
        text: "Comparing computed liabilities to filed amounts and scanning for missed obligations.",
        ms: 3200,
      },
      {
        kind: "tool",
        agent: "compliance",
        tool: "compliance.deadlines",
        detail:
          "5 deadlines this month · 1 at risk · 2 liabilities understated",
        ms: 2600,
      },
      {
        kind: "act",
        agent: "cfo",
        text: "Prioritizing the at-risk items — the understated liabilities need rate verification before filing.",
        ms: 2800,
      },
      {
        kind: "approval",
        agent: "compliance",
        text: "Compliance posture reviewed — 1 urgent, 2 to verify, 2 on track.",
        ms: 2600,
        confidence: 93,
      },
      {
        kind: "complete",
        agent: "cfo",
        text: "Compliance check complete — no penalties risked, next deadlines on the calendar.",
      },
    ],
  ),
  // ── Money — mobile money reconciliation ──────────────────────────────────
  t(
    "mobile-money-reconciliation",
    "AI Reconcile Mobile Money",
    ...
    [
      {
        kind: "think",
        agent: "treasury",
        text: "Pulling this week's mobile money transactions from Wave, MTN MoMo, and Orange Money into one feed.",
        ms: 2800,
      },
      {
        kind: "act",
        agent: "treasury",
        text: "Normalizing charges, cash-out fees, and settlement credits into ledger-ready lines.",
        ms: 3200,
      },
      {
        kind: "tool",
        agent: "treasury",
        tool: "mobileMoney.fetch",
        detail: "186 transactions · 3 providers · D 412,500 settled",
        ms: 2600,
      },
      {
        kind: "act",
        agent: "ledger",
        text: "Matching the normalized feed to cash and revenue accounts — flagging unlinked settlements.",
        ms: 3000,
      },
      {
        kind: "approval",
        agent: "cfo",
        text: "Mobile money reconciled — 182 matched, 4 settlements flagged.",
        ms: 2800,
        confidence: 95,
      },
      {
        kind: "complete",
        agent: "ledger",
        text: "Mobile money balances match the ledger — flagged settlements queued for review.",
      },
    ],
  ),
    ...
    [
      {
        kind: "think",
        agent: "reporting",
        text: "Scanning the last two quarters — revenue by product, expense drift, and working-capital movement.",
        ms: 2800,
      },
      {
        kind: "act",
        agent: "reporting",
        text: "Computing the metrics that matter — gross margin, burn, DSO, and period-over-period deltas.",
        ms: 3200,
      },
      {
        kind: "tool",
        ...
        detail: "4 trends · 2 anomalies · cash runway 14.2 months",
        ms: 2600,
      },
      {
        kind: "act",
        agent: "cfo",
        text: "Drafting the narrative — what moved, why it matters, and what to watch next month.",
        ms: 2800,
      },
      {
        kind: "approval",
        agent: "reporting",
        text: "Insight brief ready — 4 trends, 2 anomalies, 3 recommendations.",
        ms: 2600,
        confidence: 91,
      },
      {
        kind: "complete",
        agent: "cfo",
        text: "Insights published to the dashboard — CFO commentary attached.",
      },
    ],
  ),
  // ── Automation Studio — AI-proposed workflow recipes ─────────────────────
  t(
    ...
    [
      {
        kind: "think",
        agent: "cfo",
        text: "Watching the last 30 days of manual work — looking for repetitive steps worth automating.",
        ms: 2400,
      },
      {
        kind: "act",
        agent: "controller",
        text: "Cataloging the recurring patterns — invoice matching, reminder emails, and recurring journal entries.",
        ms: 3000,
      },
      {
        kind: "tool",
        agent: "cfo",
        tool: "automation.recipe",
        detail: "3 workflows proposed · 12 steps automated · ~9h saved monthly",
        ms: 2600,
      },
      {
        kind: "act",
        agent: "controller",
        text: "Drafting the workflow steps with triggers, conditions, and fallback to a human.",
        ms: 2800,
      },
      {
        kind: "approval",
        agent: "cfo",
        text: "Automation recipe ready — 3 workflows, 12 steps, 9 hours saved a month.",
        ms: 2600,
        confidence: 88,
      },
      {
        kind: "complete",
        agent: "controller",
        text: "Workflows staged in the studio — enable them one by one when you're ready.",
      },
    ],
  ),
  // ── Review Queue — AI pre-review & triage ────────────────────────────────
  t(
    "approval-pre-review",
    "AI Pre-Review Queue",
    ...
    [
      {
        kind: "think",
        agent: "cfo",
        text: "Opening the review queue — 23 items pending, reading each against policy and history.",
        ms: 2400,
      },
      {
        kind: "act",
        agent: "controller",
        text: "Pre-approving the routine items and pulling the ones that need a human eye.",
        ms: 2800,
      },
      {
        kind: "tool",
        agent: "compliance",
        tool: "approvals.preReview",
        detail: "18 auto-approved · 5 escalated · 2 policy conflicts",
        ms: 2400,
      },
      {
        kind: "act",
        agent: "controller",
        text: "Drafting decision notes so your review is one click per item.",
        ms: 2800,
      },
      {
        kind: "approval",
        agent: "cfo",
        text: "Pre-review complete — 18 resolved, 5 waiting on you.",
        ms: 2600,
        confidence: 94,
      },
      {
        kind: "complete",
        agent: "cfo",
        text: "Queue triaged — your pending items now carry full context and recommendations.",
      },
    ],
  ),
  // ── Inbox — AI document processing ───────────────────────────────────────
  t(
    "inbox-processing",
    "AI Process Inbox",
    ...
    "Inbox",
    "~35s run",
    ["document", "ap", "ar", "ledger"],
    [
      {
        kind: "think",
        agent: "document",
        text: "Opening the inbox — 41 documents: invoices, receipts, statements, and bank letters.",
        ms: 2800,
      },
      {
        kind: "act",
        agent: "document",
        text: "Extracting vendor, amounts, dates, and line items from each document.",
        ms: 3400,
      },
      {
        kind: "tool",
        agent: "document",
        tool: "document.extract",
        detail: "41 parsed · 38 ready to link · 3 need confirmation",
        ms: 2600,
      },
      {
        kind: "act",
        agent: "ap",
        text: "Matching the invoices to open purchase orders and flagging duplicates.",
        ms: 3000,
      },
      {
        kind: "act",
        agent: "ar",
        text: "Linking the confirmed invoices to open customer balances for collection follow-up.",
        ms: 2600,
      },
      {
        kind: "approval",
        agent: "ledger",
        text: "Inbox processed — 38 documents linked, 3 held for confirmation.",
        ms: 2800,
        confidence: 93,
      },
      {
        kind: "complete",
        agent: "document",
        text: "Inbox cleared — everything filed, linked, and in the audit trail.",
      },
    ],
  ),
  // ── Agent Monitor — workforce diagnostic ─────────────────────────────────
  t(
    "agent-health-check",
    ...
    [
      ...
      },
      {
        kind: "act",
        agent: "cfo",
        text: "Cross-checking each agent's throughput against its SLA and flagging bottlenecks.",
        ms: 3000,
      },
      {
        kind: "tool",
      ...
      },
      {
        kind: "act",
        agent: "controller",
        text: "Digging into the two flagged agents — one has a stuck task, one a low-confidence backlog.",
        ms: 2800,
      },
      {
        kind: "approval",
        agent: "cfo",
        text: "Workforce diagnostic ready — 2 agents need attention, rest are healthy.",
        ms: 2600,
        confidence: 92,
      },
      {
        kind: "complete",
        agent: "controller",
        text: "Diagnostic complete — the two flagged agents have remediation steps queued.",
      },
    ],
  ),
  // ── Agents — workforce overview ──────────────────────────────────────────
  t(
    "workforce-review",
    "AI Workforce Review",
    ...
    [
      {
        kind: "think",
        agent: "cfo",
        text: "Pulling today's workforce summary — tasks dispatched, completed, and escalated across all tiers.",
        ms: 2400,
      },
      {
        kind: "act",
        agent: "cfo",
        text: "Reviewing per-agent confidence trends and the items sitting in their queues.",
        ms: 2800,
      },
      {
        kind: "tool",
        ...
        tool: "agents.status",
        detail:
          "142 tasks today · 129 done · 11 escalated · avg confidence 91%",
        ms: 2400,
      },
      {
        kind: "act",
        agent: "cfo",
        text: "Noting the strongest performers and the workflows that need more training data.",
        ms: 2600,
      },
      {
        kind: "complete",
        agent: "cfo",
        text: "Workforce review ready — 142 tasks accounted for, trends summarized.",
      },
    ],
  ),
