...
/**
 * Plain-language narrative of the P&L for the current vs previous period,
 * computed server-side from REAL posted journal entries. Every sentence
 * traces to a specific variance — deterministic, explainable, never
 * hallucinated (see reports.getReportNarrative).
 */
function ReportNarrativeCard() {
  const { data, isLoading } = trpc.reports.getReportNarrative.useQuery({});
