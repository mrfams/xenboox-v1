...
const DEFAULT_FOCUS = [
  { id: "f1", label: "Monitoring 148 Employees", icon: Eye, active: true },
  { id: "f2", label: "Watching 482 Assets", icon: AlertTriangle, active: true },
  { id: "f3", label: "Tracking 18 Cost Centers", icon: FileText, active: true },
  { id: "f4", label: "Managing 4 Warehouses", icon: Boxes, active: false },
];

const DEFAULT_SUGGESTIONS = [
  {
    id: "s1",
    text: "Reduce operating costs by $28,400",
    action: "Review Savings",
  },
  {
    id: "s2",
    text: "Approve pending expense claims (12 items)",
    action: "Approve",
  },
  {
    id: "s3",
    text: "Review Marketing budget overrun of 18%",
    action: "Investigate",
  },
  {
    id: "s4",
    text: "Schedule asset maintenance for 4 items",
    action: "Schedule",
  },
];
