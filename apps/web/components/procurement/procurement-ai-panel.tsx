...
const DEFAULT_FOCUS = [
  { id: "f1", label: "Monitoring 312 suppliers", icon: Eye, active: true },
  {
    id: "f2",
    label: "Watching 17 contracts",
    icon: AlertTriangle,
    active: true,
  },
  { id: "f3", label: "Managing 94 open bills", icon: FileText, active: true },
  { id: "f4", label: "Analyzing spend trends", icon: Brain, active: false },
];

const DEFAULT_SUGGESTIONS = [
  {
    id: "s1",
    text: "Capture $8,420 in early payment discounts",
    action: "Capture Now",
  },
  {
    id: "s2",
    text: "Review ABC Manufacturing price increase",
    action: "Review",
  },
  {
    id: "s3",
    text: "Approve pending purchase order PO-2041",
    action: "Approve",
  },
  {
    id: "s4",
    text: "Negotiate Global Logistics contract renewal",
    action: "Start",
  },
];

export function ProcurementAIPanel({
  confidence = 0.97,
  onAction,
  className,
}: ProcurementAIPanelProps) {
  return (
