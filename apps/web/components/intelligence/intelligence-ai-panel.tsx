...
const DEFAULT_FOCUS = [
  { id: "f1", label: "Analyzing Revenue", icon: TrendingUp, active: true },
  { id: "f2", label: "Analyzing Expenses", icon: DollarSign, active: true },
  { id: "f3", label: "Analyzing Margins", icon: BarChart3, active: true },
  { id: "f4", label: "Forecasting Trends", icon: Brain, active: true },
  { id: "f5", label: "Benchmarking Performance", icon: Target, active: false },
];

const DEFAULT_SUGGESTIONS = [
  { id: "s1", text: "Review declining customer segments", action: "Analyze" },
  {
    id: "s2",
    text: "Find three ways to increase profit",
    action: "Find Opportunities",
  },
  { id: "s3", text: "Compare this quarter vs last quarter", action: "Compare" },
  { id: "s4", text: "Create an investor update summary", action: "Generate" },
];

export function IntelligenceAIPanel({
  confidence = 0.95,
  onAction,
  className,
}: IntelligenceAIPanelProps) {
  return (
