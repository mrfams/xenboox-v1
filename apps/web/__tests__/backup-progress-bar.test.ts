...
describe("BackupProgressIndicator", () => {
  ...
  it("Settings page imports BackupProgressIndicator", () => {
    expect(settingsPage).toContain(
      'import { BackupProgressIndicator } from "@/components/settings/backup-progress-indicator"',
    );
  });

  it("Settings page uses BackupProgressIndicator for reset onboarding", () => {
    expect(settingsPage).toContain("<BackupProgressIndicator");
  });

  it("Settings page passes tooltip with View backup link", () => {
    expect(settingsPage).toContain("View backup →");
  });
