...
describe("Reset All Settings", () => {
  ...
  describe("Card appearance", () => {
    ...
    it("has destructive styling on confirm button", () => {
      const html = 'className="bg-destructive text-destructive-foreground hover:bg-destructive/90"'
  ...
  describe("Confirmation dialog", () => {
    ...
    it("description explains what won't be affected", () => {
      const desc = "Your financial data, accounts, and documents will not be affected."
  ...
  describe("Reset scope", () => {
    it("does NOT affect financial data", () => {
      const disclaimer = "Your financial data, accounts, and documents will not be affected."
