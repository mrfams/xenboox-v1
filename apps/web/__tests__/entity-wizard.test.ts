...
describe("Entity Creation Wizard", () => {
  describe("Step definitions", () => {
    const STEPS = ["details", "chart-of-accounts", "bank-connection", "complete"]
  ...
  describe("Entity details step", () => {
    ...
    it("supports 8 currencies", () => {
      const currencies = ["GMD", "USD", "EUR", "GBP", "NGN", "KES", "ZAR", "GHS"]
  ...
  describe("Accessibility", () => {
    it("wizard has dialog role and aria-modal", () => {
      const html = '<div role="dialog" aria-modal="true" aria-label="Create new entity">'
