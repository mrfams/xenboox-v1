...
describe("Command Palette", () => {
  describe("Navigation items", () => {
    const NAV_ITEMS = [
      ...
      { label: "AI Assistant", href: "/dashboard/chat", group: "Pages", shortcut: "/" },
      ...
      { label: "Mobile Money", href: "/dashboard/mobile-money", group: "Pages" },
      { label: "Employees", href: "/dashboard/payroll", group: "Pages" },
      { label: "Fixed Assets", href: "/dashboard/fixed-assets", group: "Pages" },
      { label: "Inventory", href: "/dashboard/inventory", group: "Pages" },
      { label: "Financial Reports", href: "/dashboard/reports", group: "Pages" },
  ...
  describe("Keyboard shortcuts", () => {
    ...
    it("Ctrl+K opens command palette", () => {
      const ctrlK = SHORTCUTS.find((s) => s.description === "Open command palette")
  ...
  describe("Accessibility", () => {
    ...
    it("keyboard shortcuts are displayed as kbd elements", () => {
      const html = '<kbd className="rounded border bg-muted px-1.5 py-0.5 text-[10px] font-mono">'
