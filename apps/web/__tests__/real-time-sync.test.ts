...
describe("Real-Time Sync Indicator", () => {
  ...
  describe("Live sync indicator", () => {
    it("shows pulsing green dot when live", () => {
      const html = 'className="h-1.5 w-1.5 rounded-full bg-emerald-500 animate-pulse"'
  ...
  describe("Remote changes notification", () => {
    ...
    it("shows blue styling", () => {
      const html = 'className="rounded-lg border border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-950 p-3 space-y-2"'
  ...
  describe("Sync status icons", () => {
    ...
    it("RefreshCw for syncing", () => {
      const html = '<RefreshCw className="h-4 w-4 text-primary animate-spin" />'
  ...
  describe("Polling", () => {
    ...
    it("detects remote changes via timestamp comparison", () => {
      ...
      const serverTime = "2026-08-20T10:01:00.000Z"
