...
describe("Sidebar Onboarding Badge", () => {
  ...
  describe("Badge appearance", () => {
    it("uses pulsing animation", () => {
      const html = 'className="absolute inline-flex h-full w-full animate-ping rounded-full bg-primary/40"'
    ...
    it("uses primary color", () => {
      const html = 'className="relative inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-primary px-1 text-[10px] font-bold text-primary-foreground"'
