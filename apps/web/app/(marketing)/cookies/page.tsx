  ...
  return (
    <>
      ...
      <LegalContent>
        ...
        <p>Xenboox uses cookies strictly for essential platform operations:</p>
        ...
        <p>
          With your consent, we may use analytics cookies to understand platform
          usage patterns. You can manage your preferences at any time through
        ...
        <p>
          ...
          infrastructure providers (Vercel, Neon, AWS) may set essential cookies
          for load balancing and CDN functionality.
        </p>

        <h2>4. Managing Cookies</h2>
        <p>
          Most browsers allow you to control cookies through settings. However,
          disabling essential cookies will prevent Xenboox from functioning
          properly — authentication, session management, and security features
          all require cookies.
        </p>
