      ...
      <section className="py-16">
        <div className="mx-auto max-w-3xl px-4">
          <div className="prose prose-slate max-w-none">
            ...
            <p>
              By accessing or using Xenboox ("the Platform"), you agree to be
            ...
            <p>
              ...
              automated bookkeeping, financial reporting, payroll, tax
              compliance, and related services. The Platform uses artificial
              intelligence agents to assist with accounting tasks, but all final
              financial decisions remain the responsibility of the user and
            ...
            <ul>
              <li>
                AI agents provide recommendations and automate routine tasks —
                they do not replace professional accounting judgment
              </li>
              <li>
              ...
              <li>
                You retain full responsibility for the accuracy and completeness
            ...
            <p>
              Fees are as described on our <a href="/pricing">Pricing page</a>.
              All fees are billed in advance and are non-refundable except as
              specified in our <a href="/refund">Refund Policy</a>. We may
            ...
            <ul>
              ...
              <li>
                Attempt to bypass entity isolation or access another
                entity&apos;s data
              </li>
              <li>
              ...
              <li>
                Use automated tools to scrape or extract data beyond API rate
                limits
              </li>
              <li>
            ...
            <p>
              ...
              termination, you may export your data within 90 days. After 90
              days, your data will be permanently deleted.
            </p>

            <h2>10. Governing Law</h2>
            <p>
              These terms are governed by the laws of Ghana. Any disputes shall
              be resolved through binding arbitration in Accra, Ghana.
            </p>
