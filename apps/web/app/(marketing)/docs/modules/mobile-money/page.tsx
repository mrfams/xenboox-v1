            ...
            <Card className="border-white/10 bg-white/5">
              <CardContent className="pt-6">
                <p className="text-sm text-white/55 leading-relaxed">
                  ...
                  enabling automatic transaction syncing, reconciliation, and
                  bulk payment processing. The Mobile Money Agent monitors
                  transactions for anomalies and helps reconcile statements with
                  bank records.
                </p>
              </CardContent>
            </Card>
