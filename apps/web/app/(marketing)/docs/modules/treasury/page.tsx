    ...
    <>
      ...
      <div className="space-y-10">
          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                management and reconciliation capabilities. It supports multiple
                bank accounts across different currencies, automated transaction
                matching, and AI-powered cash flow forecasting. The Treasury
                Agent continuously monitors bank transactions, flags anomalies,
                and helps reconcile statements efficiently. Integration with the
                Ledger Agent ensures all bank transactions are properly recorded
        ...
        <InfoCallout type="info" title="Multi-Currency Support">
          ...
          real-time exchange rate integration. All transactions are recorded in
          both the transaction currency and your base reporting currency.
        </InfoCallout>
