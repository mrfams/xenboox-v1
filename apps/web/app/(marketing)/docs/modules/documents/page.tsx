          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                information, classified by type using AI, and linked to relevant
                transactions. The Document Agent manages the entire document
                lifecycle from upload through processing to archival.
              </p>
            </CardContent>
          </Card>
        </section>
        ...
        <section>
          ...
          <div className="grid gap-4 md:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-xs text-muted-foreground">
                  Link to transactions, journal entries, or records. Store in R2
                  with encryption.
                </p>
              </CardContent>
            </Card>
