      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
        ...
        <div className="space-y-10">
            ...
            <Card className="border-white/10 bg-white/5">
              <CardContent className="pt-6">
                <p className="text-sm text-white/55 leading-relaxed">
                  ...
                  approval routing, and payment scheduling, reducing manual
                  effort and minimizing errors. The module integrates with the
                  Ledger Agent for automatic journal entry creation and with the
                  Cash module for payment execution.
                </p>
              </CardContent>
            </Card>
          </section>
          ...
          <InfoCallout type="tip" title="AP Agent">
            ...
            against purchase orders, and schedule payments. Use the Chat
            interface to ask questions like "What invoices are due this week?"
