    ...
    <>
      ...
      <div className="space-y-10">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Print-ready formatted reports with company branding. Ideal for
                  board presentations and audit submissions.
                </p>
              </CardContent>
            </Card>
            <Card>
        ...
        <InfoCallout type="tip" title="Reporting Agent">
          The Reporting Agent can generate custom reports on demand. Try asking
          "Show me the P&L for last quarter" or "Generate a cash flow forecast
