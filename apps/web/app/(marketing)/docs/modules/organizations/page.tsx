      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
        ...
        <div className="space-y-10">
            ...
            <Card className="border-white/10 bg-white/5">
              <CardContent className="pt-6">
                <p className="text-sm text-white/55 leading-relaxed">
                  ...
                  administration, and role-based access control that ensures
                  data isolation across all accounting modules. Every database
                  query is automatically scoped to the user's entity, and
                  Row-Level Security (RLS) is enforced at the database layer for
                  defense-in-depth.
                </p>
              </CardContent>
            </Card>
          ...
          <InfoCallout type="info" title="Entity Scoping">
            ...
            application layer (tRPC middleware) and the database layer
