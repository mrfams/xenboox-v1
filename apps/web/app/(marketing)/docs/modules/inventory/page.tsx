          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                categorization, stock movement tracking, and multiple valuation
                methods. The Inventory Agent monitors stock levels, predicts
                reorder needs, and helps optimize inventory carrying costs.
                Integration with the AP module enables automated purchase order
                generation when stock reaches reorder levels.
              </p>
            </CardContent>
          </Card>
        </section>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  First-In, First-Out method assumes oldest inventory items are
                  sold first. Best for perishable goods or products with expiry
                  dates.
                </p>
              </CardContent>
            </Card>
