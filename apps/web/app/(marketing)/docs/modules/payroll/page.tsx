      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
        ...
        <div className="space-y-10">
            ...
            <Card className="border-white/10 bg-white/5">
              <CardContent className="pt-6">
                <p className="text-sm text-white/55 leading-relaxed">
                  ...
                  elements, tax bands, and deduction profiles. The Payroll
                  Manager Agent automates monthly runs and ensures compliance
                ...
                <tbody>
                  {taxBands.map((row) => (
                    <tr key={row.band} className="border-b last:border-0">
                      ...
                      <td className="px-4 py-3 text-white/55">{row.notes}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <Card className="border-white/10 bg-white/5">
              <CardContent className="pt-6">
                <p className="text-sm text-white/55 mb-4">
                  The Payroll module supports the following statutory
                  deductions:
                </p>
                <ul className="space-y-2 text-sm text-white/55">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>PAYE Tax</strong> — Pay As You Earn income tax
                  ...
                  <li className="flex items-start gap-2">
                    <div className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary/60" />
                    <span>
                      <strong>Provident Fund</strong> — Optional
          ...
          <InfoCallout type="tip" title="Payroll Manager Agent">
            The Payroll Manager Agent can automate monthly payroll runs,
            validate calculations, and generate statutory reports. Try asking
            "Run payroll for this month" or "Show me the payroll summary for
            Q2."
          </InfoCallout>
