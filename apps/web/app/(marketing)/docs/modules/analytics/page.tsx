      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
        ...
        <div className="space-y-10">
            ...
            <Card className="border-white/10 bg-white/5">
              <CardContent className="pt-6">
                <p className="text-sm text-white/55 mb-3">
                  Xenboox supports a multi-LLM architecture. The Analytics
          ...
          <InfoCallout type="tip" title="Analytics Agent">
            ...
            platform usage. Ask "Show me my AI spending this month" or "What's
            the most cost-effective model for invoice processing?"
          </InfoCallout>
