import { Globe, ArrowRightLeft, RefreshCw, BarChart3 } from "lucide-react";
    ...
    <>
      ...
      <div className="space-y-10">
          ...
          <Card>
            <CardContent className="pt-6">
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                transactions in any currency while maintaining accurate books in
                their base reporting currency. Real-time exchange rates from
                multiple providers ensure accurate conversions, and automatic
                gain/loss calculations help maintain accurate financial
                positions. The module supports 150+ currencies and integrates
                with all other accounting modules for seamless multi-currency
                operations.
              </p>
            </CardContent>
          </Card>
              ...
              <div className="space-y-4 text-sm text-muted-foreground">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <br />
                    Set up automatic rate updates from your preferred provider.
                    Manual rate overrides available for historical entries.
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary text-sm font-bold">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    automatically calculated and posted to appropriate accounts.
                  </div>
                </div>
              </div>
            </CardContent>
        ...
        <InfoCallout type="info" title="Exchange Rate Providers">
          ...
          exchangerate-api.com, and central bank feeds. Configure your preferred
          provider in entity settings.
        </InfoCallout>
