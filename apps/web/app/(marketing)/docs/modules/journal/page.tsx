      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
        ...
        <div className="space-y-10">
            ...
            <Card className="border-white/10 bg-white/5">
              <CardContent className="pt-6">
                <p className="text-sm text-white/55 leading-relaxed">
                  The Journal module is the core transaction processing engine
                  of Xenboox. It handles all double-entry journal entries with
                  automatic debit/credit validation, approval workflows, and
                  seamless posting to the general ledger. The Ledger Agent
                  automates entry creation from various sources (AP, AR,
                  Payroll, Treasury) and validates every entry for accounting
                  integrity. All entries maintain a complete audit trail from
                  creation through posting and reversal.
                </p>
              </CardContent>
            </Card>
          </section>
          ...
          <InfoCallout type="tip" title="Ledger Agent">
            ...
            credits, and maintains the audit trail. Ask "Post this journal
            entry" or "Show me unposted entries."
          </InfoCallout>
