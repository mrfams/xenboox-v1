        ...
        <div className="space-y-10">
            ...
            <Card className="border-white/10 bg-white/5">
              <CardContent className="pt-6">
                <p className="text-sm text-white/55 leading-relaxed">
                  ...
                  The chat interface supports file uploads, command shortcuts,
                  and conversation history with search. Each message is
                  processed by the appropriate agent based on context and
                  intent.
                </p>
              </CardContent>
            </Card>
          ...
          <section>
            ...
            <Card className="border-white/10 bg-white/5">
              <CardContent className="pt-6">
                <p className="text-sm text-white/55 leading-relaxed">
                  When you send a message in chat, the system routes your
                  request to the appropriate AI agent based on context and
                  intent. For example, a question about overdue invoices is
                  routed to the AR Agent, while a payroll question goes to the
                  Payroll Manager Agent. The CFO Agent handles strategic
                  questions and coordinates responses from multiple agents when
                  needed.
                </p>
              </CardContent>
            </Card>
          ...
          <InfoCallout type="tip" title="Getting Started with Chat">
            Try starting with simple questions about your data. The AI agents
            are designed to be conversational and will guide you through complex
            tasks step by step. Type "/help" to see all available commands.
          </InfoCallout>
