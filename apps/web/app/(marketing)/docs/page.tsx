...
const docCategories = [
  {
    ...
    description: "Set up your account, create entities, record your first journal entry.",
  ...
  {
    title: "Modules",
    description: "Explore all 19 accounting modules — AP, AR, Payroll, Treasury, Cash, and more.",
    href: "/docs/modules",
    icon: FileText,
  ...
  {
    title: "AI Agents",
    description: "Learn about all 19 AI-powered assistants — from CFO to Audit Agent.",
    href: "/docs/agents",
    icon: Bot,
  ...
  {
    title: "Security",
    description: "CSP, authentication, encryption, rate limiting, and compliance.",
    href: "/docs/security",
    icon: Shield,
  ...
  },
  {
    ...
    description: "CI/CD pipeline, deployment, monitoring, backup, incident response.",
    href: "/docs/devsecops",
    icon: Server,
  ...
  {
    title: "FAQ",
    description: "Common questions about billing, security, AI agents, and platform usage.",
    href: "/docs/faq",
    icon: HelpCircle,
...
const quickLinks = [
  { title: "Journal Entries", href: "/docs/modules/journal", description: "Double-entry accounting" },
  { title: "Chart of Accounts", href: "/docs/modules/coa", description: "Account structure" },
  { title: "Bank Reconciliation", href: "/docs/modules/treasury", description: "Match transactions" },
  { title: "Payroll Processing", href: "/docs/modules/payroll", description: "Run payroll" },
  { title: "Mobile Money", href: "/docs/modules/mobile-money", description: "M-Pesa, Airtel" },
  { title: "Reports", href: "/docs/modules/reports", description: "Financial statements" },
]
...
export default function DocsLandingPage() {
  return (
    <>
      {/* Hero Section */}
      <div className="relative mb-12 overflow-hidden rounded-2xl border bg-gradient-to-br from-primary/5 via-background to-background">
        <div className="relative px-6 py-10 sm:px-10 sm:py-14">
          ...
          <p className="mt-3 max-w-xl text-sm sm:text-base text-muted-foreground leading-relaxed">
            ...
            Explore 19 modules, 19 AI agents, and enterprise-grade security features.
          </p>
      ...
      <div className="mt-12 border-t pt-8">
        <h2 className="text-sm font-semibold text-muted-foreground mb-3">LEGAL & POLICIES</h2>
        <div className="grid gap-2 sm:grid-cols-2">
          {[
            { label: "Privacy Policy", href: "/privacy", desc: "Data protection and user privacy" },
            { label: "Terms of Service", href: "/terms", desc: "Terms governing platform use" },
            { label: "Cookie Policy", href: "/cookies", desc: "Cookie and tracking details" },
            { label: "Service Level Agreement", href: "/sla", desc: "Uptime guarantees and support" },
          ].map((item) => (
