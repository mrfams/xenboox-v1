  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          Specialized AI agents handle your books while you run the business.
        </div>
        ...
        >
          {[
            { icon: "🤖", label: "20+ AI Agents" },
            { icon: "🌍", label: "50+ Currencies" },
