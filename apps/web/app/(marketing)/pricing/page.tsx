...
const monthlyTiers = [
  {
    ...
    features: [
      "1 entity",
      "Ask anything, AI does the books",
  ...
  },
  {
    ...
    price: "$29",
    period: "/month",
    description: "Your daily accounting, handled.",
    annualSavings: 58,
    features: [
      "Up to 3 entities",
      "Full close, payroll & compliance on autopilot",
  ...
  },
  {
    ...
    price: "$79",
    period: "/month",
    description: "Scale to multiple entities — without the complexity.",
    annualSavings: 158,
    features: [
      "Up to 10 entities",
      "Everything in Starter, for every entity",
  ...
  },
  {
    ...
    features: [
      "Unlimited entities",
      "Everything in Business, at any scale",
      "Unlimited everything",
