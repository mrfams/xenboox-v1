  ...
  return (
    <>
      ...
      <LegalContent>
        ...
        <ul>
          <li>
            <strong>Uptime:</strong> The percentage of time during a calendar
            month that the Xenboox platform is accessible via the web
            application and API.
          </li>
          <li>
          ...
          <li>
            <strong>Scheduled Maintenance:</strong> Pre-announced maintenance
            windows, typically outside business hours (UTC±0 22:00–06:00) with
        ...
        <ul>
          <li>Downtime caused by user-side network or infrastructure issues</li>
          <li>
            Third-party service provider outages (bank feeds, mobile money APIs,
            cloud providers)
          </li>
          <li>
            Beta features or features explicitly labeled as &quot;preview&quot;
            or &quot;experimental&quot;
          </li>
          <li>
          ...
          <li>
            Force majeure events including natural disasters, civil unrest, or
        ...
        <p>
          ...
          <a href="mailto:support@xenboox.com">support@xenboox.com</a> within 30
          days of the incident with:
        </p>
        <ul>
        ...
        <table className="min-w-full border-collapse text-sm">
          ...
          <tbody>
            <tr className="border-b">
              ...
              <td className="py-2 pr-4">Platform unavailable or data loss</td>
        ...
        <p>
          Platform uptime is monitored continuously. Monthly uptime reports are
          published on our <a href="https://status.xenboox.com">status page</a>.
        </p>
      </LegalContent>
    </>
  );
