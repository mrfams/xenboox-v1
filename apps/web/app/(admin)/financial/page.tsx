...
export default function FinancialPage() {
  ...
  const financialHealth = overview?.totalBankBalance && overview.totalBankBalance > 0 ? "healthy" : 
                         overview?.totalBankBalance && overview.totalBankBalance > -10000 ? "warning" : "critical"
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Monitor organization financial metrics and health indicators</p>
        </div>
