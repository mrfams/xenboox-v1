...
export function AddSupplierDialog({ open, onClose, onSuccess }: Props) {
    ...
    <Dialog open={open} onClose={onClose} title="Add Supplier">
      <div className="space-y-4">
        ...
        <div className="flex justify-end gap-2 pt-2">
          ...
          <Button onClick={() => mutation.mutate({ name, contactEmail: email || undefined, contactPhone: phone || undefined, paymentTerms })} disabled={!name || mutation.isPending}>
