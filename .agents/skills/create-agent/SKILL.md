---
name: create-agent
description: Creates or modifies LangGraph agents in the Xenboox codebase. Use when building a new agent, modifying agent behavior, troubleshooting agent issues, or extending agent functionality.
license: MIT
metadata:
  author: xenboox
...
export const getAccountBalance = tool(
  ...
  },
  {
    ...
    description:
      "Get the current balance of a specific account in the chart of accounts",
    schema: z.object({
