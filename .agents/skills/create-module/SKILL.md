---
name: create-module
description: Scaffolds a complete new accounting module (payroll, invoicing, assets, budget, etc.) in Xenboox including database schema, tRPC router, frontend components, page route, and agent tools. Use when building a new domain module for the platform.
license: MIT
metadata:
  author: xenboox
