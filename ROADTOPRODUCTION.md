...
- `[ ]` **Semantic caching** for repeated questions ("what was my cash balance?") — Redis/Upstash cache keyed on normalized intent; saves 30–70% of spend on chat surfaces. — **next issue (§22.1 semantic caching)**
